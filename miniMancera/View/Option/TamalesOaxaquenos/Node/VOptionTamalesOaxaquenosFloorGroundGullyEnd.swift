...
class VOptionTamalesOaxaquenosFloorGroundGullyEnd:VOptionTamalesOaxaquenosFloor
{
    private weak var viewGround:VOptionTamalesOaxaquenosFloorGround!
    private weak var viewGully:VOptionTamalesOaxaquenosFloorGullyEnd!
    ...
    init(
        ...
        model:MOptionTamalesOaxaquenosAreaFloorItemGroundGullyEnd)
    {
        ...
        let viewGully:VOptionTamalesOaxaquenosFloorGullyEnd = VOptionTamalesOaxaquenosFloorGullyEnd(
            controller:controller)
